   ...
   public class ComputeFunction
    {
        ...
        public ComputeFunction(EvaluatorItem[] items)
        {
        ...
        public ComputeFunction(Type returnType, string expression, string name)
        {
            //创建可执行字符串数组     
        ...
        public ComputeFunction(EvaluatorItem item)
        {
        ...
        private void ConstructEvaluator(EvaluatorItem[] items)
        {
            ...
            code.Append("namespace LionvCommon {  ");                  //生成代码的命名空间为EvalGuy，和本代码一样     
            ...
            _Compiled = a.CreateInstance("LionvCommon._Evaluator");     //通过程序集查找并声明 SSEC.Math._Evaluator 的实例     
        }
        #endregion
        ...
        {
            ComputeFunction eval = new ComputeFunction(typeof(int), code, staticMethodName);//生成 Evaluator 类的对像     
        ...
        {
            ComputeFunction eval = new ComputeFunction(typeof(double), code, staticMethodName);//生成 Evaluator 类的对像     
        ...
        {
            ComputeFunction eval = new ComputeFunction(typeof(long), code, staticMethodName);//生成 Evaluator 类的对像     
        ...
        {
            ComputeFunction eval = new ComputeFunction(typeof(decimal), code, staticMethodName);//生成 Evaluator 类的对像     
        ...
        {
            ComputeFunction eval = new ComputeFunction(typeof(string), code, staticMethodName);//生成 Evaluator 类的对像     
        ...
        {
            ComputeFunction eval = new ComputeFunction(typeof(bool), code, staticMethodName);//生成 Evaluator 类的对像     
        ...
        {
            ComputeFunction eval = new ComputeFunction(typeof(object), code, staticMethodName);//生成 Evaluator 类的对像     
