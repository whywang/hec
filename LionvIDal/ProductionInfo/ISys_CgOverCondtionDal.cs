...
{
   public interface ISys_CgOverCondtionDal
    {
        #region  成员方法
        /// <summary>
        /// 是否存在该记录
        ...
        /// 增加一条数据
        /// </summary>
        int Add( Sys_CgOverCondtion model);
        /// <summary>
        /// 更新一条数据
        /// </summary>
        bool Update( Sys_CgOverCondtion model);
        /// <summary>
        /// 删除一条数据
        /// </summary>
        ...
        /// 得到一个对象实体
        /// </summary>
        Sys_CgOverCondtion Query(string where);
 
        /// <summary>
        /// 获得数据列表
        /// </summary>
        List<Sys_CgOverCondtion> QueryList(string strWhere);
