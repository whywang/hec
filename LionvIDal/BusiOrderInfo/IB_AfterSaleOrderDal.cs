...
{
    public interface IB_AfterSaleOrderDal
    {
        #region  成员方法
        /// <summary>
        /// 是否存在该记录
        ...
        /// 增加一条数据
        /// </summary>
        int Add(B_AfterSaleOrder model);
        /// <summary>
        /// 更新一条数据
        /// </summary>
        bool Update(B_AfterSaleOrder model);
        /// <summary>
        /// 删除一条数据
        /// </summary>
        ...
        /// 得到一个对象实体
        /// </summary>
        B_AfterSaleOrder Query(string where);
        List<B_AfterSaleOrder> QueryList(string strWhere);
        ...
        //int SetDuty(string sid, string dcode, string clfs);
