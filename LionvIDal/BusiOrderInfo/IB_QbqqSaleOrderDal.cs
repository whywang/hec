...
namespace LionvIDal.BusiOrderInfo
{
    ...
    /// 接口层B_MzSaleOrder
    /// </summary>
    public interface IB_QbqqSaleOrderDal
    {
        #region  成员方法
        /// <summary>
        /// 是否存在该记录
        ...
        /// 增加一条数据
        /// </summary>
        int Add( B_QbqqSaleOrder model);
        /// <summary>
        /// 更新一条数据
        /// </summary>
        bool Update( B_QbqqSaleOrder model);
 
        bool Delete(string idlist);
        /// <summary>
        /// 得到一个对象实体
        /// </summary>
         B_QbqqSaleOrder Query(string where);
 
        /// <summary>
        /// 获得数据列表
        /// </summary>
         List<B_QbqqSaleOrder> QueryList(string strWhere);
