Class('App.ChangeProductionDlg', 'linb.Com', {
    Instance: {
        base: ["linb.UI"],
        ...
        iniComponents: function () {
            ...
            host.pt.append(
                ...
                .setItems([{ "id": "grp1", "sub": [{ "id": "a1", "caption": "确定", "image": "../../../Image/BtnImg/sub.png" }, { "id": "a2", "type": "split", "split": true }, { "id": "a3", "caption": "取消产品", "image": "../../../Image/BtnImg/back.png"}], "caption": "grp1"}])
            ...
            host.pt.append(
                ...
                .setLeft(30)
                .setTop(40)
                .setCaption("<span style='font-size:16px;font-weight:bolder;color:#666666'>更改产品</span>")
            );

            host.pt.append(
                (new linb.UI.ComboInput)
                .setHost(host, "selpnum")
                .setLeft(320)
                .setTop(50)
                .setWidth(290)
                .setHeight(50)
                .setLabelSize(20)
                .setLabelPos("top")
                .setLabelCaption("<span style='font-size:16px;color:#666666'>选择产品序号</span>")
                .setLabelHAlign("left")
                .setType("listbox")
            ...
            host.pmt.append(
                ...
                .setLabelHAlign("left")
                .setType("listbox")
                .setItems([{ "id": "无", "caption": "无" }, { "id": "左手推开", "caption": "左手推开" }, { "id": "右手推开", "caption": "右手推开" }, { "id": "左手拉开", "caption": "左手拉开" }, { "id": "右手拉开", "caption": "右手拉开" }, { "id": "左先推开", "caption": "左先推开" }, { "id": "右先推开", "caption": "右先推开" }, { "id": "左先拉开", "caption": "左先拉开" }, { "id": "右先拉开", "caption": "右先拉开"}])
            );
        ...
        _selpnum_onchange: function (profile, oldValue, newValue) {
            var ns = this, uictrl = profile.boxing();
            EditProductions(osid, newValue)
            gnum = newValue;
        }
    },
    Static: {
...
function QueryEditProductionNum() {
    var o = { "sid": sid }
    var url = "../../../UIServer/CommonFile/Production.aspx/QueryGroupEditProductionNum"
    var b = AjaxExb(url, o);
...
function SaveProduction() {
    if (SaveProductionCheck()) {
        ...
        var arg1 = { "sid":sid , "osid":osid,"gnum": gnum }
        var db = linb.DataBinder.getFromName("abinder");
        var arg2 = db.updateDataFromUI().getData();
        var o = $.extend(arg1, arg2);
        var url = '../../../UIServer/ChangeServiceBusiness/DistributorChangeDoorMqOrder/AddSaleOrderProduction.aspx/SaveProduction';
        var b = AjaxExb(url, o);
