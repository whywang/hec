Class('App.AfterAddYqProductionDlg', 'linb.Com', {
    Instance: {
        base: ["linb.UI"],
        ...
        iniComponents: function () {
            ...
            host.apdlg.append(
                ...
                .setHost(host, "plistp")
                .setDock("fill")
                .setCustomStyle({ "KEY": "background:#333333; filter:alpha(Opacity=90);-moz-opacity:0.9;opacity: 0.9; " })
            );
            ...
            host.plistp.append(
                ...
                .setTop(100)
                .setHeight(350)
                .setCustomStyle({ "KEY": "background:#000000;" })
            );
            ...
            host.plt.append(
                (new linb.UI.ToolBar)
                .setHost(host, "itoolbar")
                .setItems([{ "id": "grp1", "sub": [{ "id": "a1", "caption": "确定"}], "caption": "grp1"}])
                .onClick("_itoolbar_onclick")
            );

            host.plist.append(
                (new linb.UI.TreeGrid)
                .setHost(host, "iptreegrid")
                .setAltRowsBg(true)
                .setRowNumbered(true)
                .setHeaderHeight(25)
                .setRowHeight(25)
                .setEditable(true)
                .setHeader([{ "id": "rid", "type": "label", "width": 80, "caption": "行ID" }, { "id": "bjname", "type": "label", "width": 140, "caption": "部件名称" }, { "id": "bjh", "type": "number", "width": 120, "caption": "部件高" }, { "id": "bjk", "type": "number", "width": 120, "caption": "部件宽" }, { "id": "bjh", "type": "number", "width": 120, "caption": "部件厚" }, { "id": "bjsl", "type": "number", "width": 120, "caption": "部件数量"}])
           );
        ...
        _itoolbar_onclick: function (profile, item, group, e, src) {
            var ns = this, uictrl = profile.boxing();
            SaveProductionItems();
        }
    },
...
function SaveProduction() {
    ...
    if (SaveProductionCheck()) {
        ...
        var arg1 = { "sid": sid, "gnum": gnum,"optype":"f" }
...
function QueryProductionItems(b) {
    ds.plistp.setDisplay("block")
    var o = { "sid": sid, "gnum": b }
    var url = '../../../UIServer/CommonFile/Production.aspx/QueryItemProduction';
    var b = AjaxExb(url, o);
    ds.iptreegrid.removeAllRows();
    var r = BackVad(b, "", false)
    if (r) {
        var arr = new Array();
        for (i = 1; i < r.length; i++) {
            ...
            arr.push({ "id": cel[0], "cells": [{ "value": cel[0] }, { "value": cel[1] }, { "value": cel[2] }, { "value": cel[3] }, { "value": cel[4] }, { "value": cel[5] }, { "value": cel[6], "editable": true }] })

        }
        ds.iptreegrid.setRows(arr)
    }
}
function SaveProductionItems() {
    var prow = ds.iptreegrid.getRows("min")
    var o = { "itemlist": prow }
    var url = '../../../UIServer/CommonFile/Production.aspx/AfterSaveItemProduction';
    var b = AjaxExb(url, o);
