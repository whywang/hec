Class('App.UpPriceFileDlg', 'linb.Com', {
    Instance: {
        base: ["linb.UI"],
        ...
        iniComponents: function () {
            ...
            host.pfj.append(
                ...
                .setWidth(430)
                .setHeight(30)
                .setHtml("<input type='file' name='pfile' id='pfile'  accept='application/vnd.ms-excel'  style='height:28px; width:420px'/>")
            );
        ...
        _ctoolbar_onclick: function (profile, item, group, e, src) {
            ...
            if (item.id == "a1") {
                ...
                if (!CheckInput(ds, ds.oprice, true, "number", "请输订单金额！", "请正确输入金额", "", "", "")) {
                    return
                }
                var fname = ds.fname.getUIValue();
                var oprice = ds.oprice.getUIValue()
                var url = "../../../UIServer/MzSaleBusiness/DistributorMzSale/UpPriceFile.aspx?sid=" + sid + "&fname=" + fname + "&oprice=" + oprice + "";
...
function QueryPriceFile() {
    var o = { "sid": sid }
    var url = '../../../UIServer/MzSaleBusiness/DistributorMzSale/MzPlanProduction.aspx/QueryPriceList';
    var b = AjaxExb(url, o);
...
function DelPriceFile(id) {
    var o = { "pid": id }
    var url = "../../../UIServer/MzSaleBusiness/DistributorMzSale/MzPlanProduction.aspx/DelPrice"
    var b = AjaxExb(url, o);
