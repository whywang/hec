...
{
    public partial class XsOverCondition : System.Web.UI.Page
    {
        private static JavaScriptSerializer js = new JavaScriptSerializer();
        private static Sys_XsOverCondtionCategoryBll snsb = new Sys_XsOverCondtionCategoryBll();
        private static Sys_XsOverConditionBll cocb = new Sys_XsOverConditionBll();
        ...
        {
            string r = "";
            Sys_XsOverCondtionCategory sns = new Sys_XsOverCondtionCategory();
            SessionUserValidate iv = SysValidateBll.ValidateSession();
            if (iv.f)
            {
                Sys_XsOverCondtionCategory csns = snsb.Query(" and ocode='" + ocode + "'");
                if (csns != null)
                {
                    r = js.Serialize(csns);
                }
        ...
        public static string SaveOverConditionCate(string lcode, string lid, string lname, string ltype, string lunit)
        {
            ...
            if (iv.f)
            {
                Sys_XsOverCondtionCategory s = new Sys_XsOverCondtionCategory();
                s.oname = lname;
                s.ocode = lcode;
                s.otype = ltype;
                s.ounit = lunit;
        ...
        public static ArrayList QueryListCate()
        {
            ...
            List<Sys_XsOverCondtionCategory> lsf = new List<Sys_XsOverCondtionCategory>();
            ...
            if (iv.f)
            {
                ...
                if (lsf != null)
                {
                    foreach (Sys_XsOverCondtionCategory s in lsf)
                    {
        ...
        {
            ArrayList r = new ArrayList();
            List<Sys_XsOverCondition> lsf = new List<Sys_XsOverCondition>();
            SessionUserValidate iv = SysValidateBll.ValidateSession();
            if (iv.f)
            {
                r.Add(iv.badstr);
                ...
                if (lsf != null)
                {
                    foreach (Sys_XsOverCondition s in lsf)
                    {
                        ArrayList al = new ArrayList();
                        al.Add(s.ccode);
                        al.Add(s.oname);
