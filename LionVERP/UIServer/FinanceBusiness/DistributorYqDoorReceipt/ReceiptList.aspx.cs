...
namespace LionVERP.UIServer.FinanceBusiness.DistributorYqDoorReceipt
{
    public partial class ReceiptList : System.Web.UI.Page
    {
        ...
        #region// 获取订单列表
        [WebMethod(true)]
        public static ArrayList QuerySaleReceiptList(string bdate, string city, string code, string curpage, string customer, string dname, string edate, string emcode, string pagesize, string tabcode)
        {
