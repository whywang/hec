...
namespace LionVERP.UIServer.StorageBusiness.DistributorInStorageMzOrder
{
    public partial class MzInHouseList : System.Web.UI.Page
    {
        ...
        #region// 获取订单列表
        [WebMethod(true)]
        public static ArrayList QueryInHouseList(string bdate, string city, string code, string curpage, string customer, string edate, string emcode, string fname, string pagesize, string tabcode)
        {
