...
{
    public partial class WjList : System.Web.UI.Page
    {
        ...
        #region// 获取销售五金
        [WebMethod(true)]
        public static ArrayList QueryInHouseList(string bdate, string code, string curpage, string customer, string edate, string emcode, string fname, string pagesize, string platform, string tabcode)
        {
            ...
            if (iv.f)
            {
                ...
                if (platform != "")
                {
                    where.AppendFormat(" and e_city like '%{0}%'", platform);
                }
                if (bdate != "" && bdate != null)
                {
        ...
        #region// 获取反馈五金
        [WebMethod(true)]
        public static ArrayList QueryAfterInHouseList(string bdate, string code, string curpage, string customer, string edate, string emcode, string fname, string pagesize, string platform, string tabcode)
        {
            ArrayList r = new ArrayList();
            DataTable lsr = new DataTable();
            StringBuilder where = new StringBuilder();
