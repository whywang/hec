...
{
    public partial class AfterCityInHouseList : System.Web.UI.Page
    {
        ...
        #region// 获取订单列表
        [WebMethod(true)]
        public static ArrayList QueryCityInHouseList(string bdate, string code, string curpage, string customer, string edate, string emcode, string fname, string pagesize, string platform, string tabcode)
        {
