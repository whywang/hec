...
using System.Data;
using System.Text;
namespace LionVERP.UIServer.StorageBusiness.DistributorYqDoorOrder
{
    public partial class InHouseList : System.Web.UI.Page
    {
        ...
        #region// 获取订单列表
        [WebMethod(true)]
        public static ArrayList QueryOrderList(string bdate, string city, string code, string curpage, string customer, string edate, string emcode, string fname, string pagesize, string tabcode)
        {
