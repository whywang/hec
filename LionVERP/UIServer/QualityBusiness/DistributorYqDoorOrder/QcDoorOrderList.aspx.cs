...
namespace LionVERP.UIServer.QualityBusiness.DistributorYqDoorOrder
{
    public partial class QcDoorOrderList : System.Web.UI.Page
    {
        ...
        #region// 获取订单列表
        [WebMethod(true)]
        public static ArrayList QueryProdutionList(string bdate, string city, string code, string curpage, string customer, string dname, string edate, string emcode, string pagesize, string tabcode)
        {
