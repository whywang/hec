...
(function ($, window, document, undefined) {
    ...
    /**
	 * 鐩墠闃舵娑夊強鍙傛暟璇存槑 { title: 'modal鏍囬', text: '鎻愮ず鍐呭', ok_label: '纭畾鎸夐挳鐨勫唴瀹�',
	 * cancel_label: '鍙栨秷鎸夐挳鐨勫唴瀹�', callback: '纭畾鎸夐挳鐨勫洖璋冨嚱鏁�', cancel_call: '鍙栨秷鎸夐挳鐨勫洖璋冨嚱鏁�',
	 * large: 'modal澶у皬妯″紡' }
	 */
    var _CONFIG = {
        ok_label: 'sdf',
    ...
    var _TITLE = { info: 'rty', correct: 'yui', warn: 'nm,', error: 'dfg' };
    ...
    /**
	 * 鐢ㄦ硶: 1.modals.info('...'); 2.modals.info({ ... });
	 * 
	 * correct銆亀arn銆乪rror鍙笉瑕併€備负缁熶竴瑙勮寖灏介噺閫夋嫨鐩稿簲鍑芥暟
	 * 
	 * @returns {*}
	 */
    ...
    /**
	 * 鐢ㄦ硶: 1.modals.confirm('...'); 2.modals.confirm({ ... });
	 * 
	 * @returns {*}
	 */
    modals.confirm = function() {
        var cfg = modal_params.apply(this, arguments);
        cfg.title = cfg.title||'123';
        cfg.cancel_label = cfg.cancel_label==_CONFIG.cancel_label?'345':cfg.cancel_label;
     ...
     ***************************************************************************/
    //{"backdrop":"static"}鐐瑰嚮鑳屾櫙涓嶄細娑堝け  
    var _win_config={winId:'user-win',backdrop:true,keyboard:true,width:900};
    //config={win:'userWin',top:'auto'/20,width:'900px',title:'wer234'}
