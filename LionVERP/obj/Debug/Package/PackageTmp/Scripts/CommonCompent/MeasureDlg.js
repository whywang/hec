    ...
    Instance: {
        ...
        iniComponents: function () {
            ...
            host.pbj.append(
                ...
                .setLeft(20)
                .setTop(40)
                .setCaption("<span style='font-size:16px;font-weight:bolder;color:#666666'>测量单</span>")
            );
...
function QueryServiceImgList() {
    var o = { "sid": sid }
    var url = '../../../UIServer/CommonFile/ImageFiles.aspx/QueryMeasureImgHtm';
    var b = AjaxExb(url, o);
    ds.pml.setHtml(b)
}
$("#ifile").live('change', function () {
    var url = "../../../UIServer/CommonFile/UpMeasureImg.aspx?sid=" + sid + "&clname=";
    UpFile(null, "ifile", url, "QueryServiceImgList();WorkFlowBar(emcode, sid, ns.toolbar)");
})

function DelImg(id) {
    var o = { "id":id }
    var url = '../../../UIServer/CommonFile/ImageFiles.aspx/DelMeasureImg';
    var b = AjaxExb(url, o);
