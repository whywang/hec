...
{
   public class Sys_SizeFormatCollectionBll
    {
       private readonly ISys_SizeFormatCollectionDal dal=DataProductionAccess.CreateSys_SizeFormatCollection();
		...
		/// 得到一个对象实体
		/// </summary>
		public  Sys_SizeFormatCollection Query(string id)
		{
        ...
        {
            return dal.AddList(sfccode,lsc);
        }
