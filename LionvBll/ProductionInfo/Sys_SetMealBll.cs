...
{
   public class Sys_SetMealBll
    {

       private readonly ISys_SetMealDal dal = DataProductionAccess.CreateSys_SetMeal();
 
		#region  BasicMethod
		/// <summary>
		/// 是否存在该记录
		/// </summary>
		public bool Exists(string tccode)
		{
			return dal.Exists(tccode);
		}
