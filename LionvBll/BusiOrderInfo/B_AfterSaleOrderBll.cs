...
{
    public class B_AfterSaleOrderBll
    {
        private readonly IB_AfterSaleOrderDal dal = BusiOrderAccess.CreateB_AfterSaleOrder();
		...
		/// 获得数据列表
		/// </summary>
		public List< B_AfterSaleOrder> QueryList(string where)
		{
        ...
        //}
        //public int SetDuty(string sid, string dcode, string clfs)
        //{
        //    return dal.SetDuty(sid, dcode, clfs);
        //}
