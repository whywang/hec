...
{
   public class B_SaleChangeOrderBll
    {
        private readonly IB_SaleChangeOrderDal dal=BusiOrderAccess.CreateB_SaleChangeOrder();
		...
		/// 得到一个对象实体
		/// </summary>
		public  B_SaleChangeOrder Query(string id)
		{
        ...
        {
            return dal.UpChangeCost(sid, ccost, pjd, cremark);
        }
