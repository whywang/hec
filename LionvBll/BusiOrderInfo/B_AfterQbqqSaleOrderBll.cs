...
{
   public class B_AfterQbqqSaleOrderBll
    {
        private readonly IB_AfterQbqqSaleOrderDal dal=BusiOrderAccess.CreateB_AfterQbqqSaleOrder();
		...
		/// 得到一个对象实体
		/// </summary>
		public  B_AfterQbqqSaleOrder Query(string id)
		{
